            ...
            >
              ...
              <Box sx={{ mb: 4, width: { xs: '100%', md: '70%' } }}>
                <Typography sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                  Nuestra misión es transformar el mundo del cuidado de las mascotas, convirtiéndonos en el ecosistema
                  digital indispensable para que tengan una vida plena y saludable
                </Typography>
              </Box>
              <Box sx={{ '& button': { mr: 2 } }}>
